...
| 1.0.2（非正式版本） | 2021.2.1 | 叶郅祺 | 修改了错误码 |

版本1.1修订：  
+ 增加了“用户名密码错误”的错误码为100，原100错误变成101
+ 合并了210、260、270错误码至202
+ 增加了错误码999：“未预料的错误”；错误码4：“参数取值错误”
